...
interface TripRepository {
    ...
    suspend fun getPendingTrips(forceRefresh: Boolean = false): List<Trip>
    suspend fun getConfirmedTrips(forceRefresh: Boolean = false): List<Trip>
    suspend fun getTripDetails(tripId: Int, forceRefresh: Boolean = false): Trip
    suspend fun confirmParticipation(tripId: Int)
    suspend fun rejectParticipation(tripId: Int)
    ...
    suspend fun getBudgetCategories(): List<BudgetCategoryLookup>
}